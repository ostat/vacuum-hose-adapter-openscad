...
Save-CombinedOpenScadFile -ScadFilePath (join-path $script:SourceFolder 'vacuum-hose-adapter-openscad.scad') -OutputFolder $OutputFolder
Save-CombinedOpenScadFile -ScadFilePath (join-path $script:SourceFolder 'funnels.scad') -OutputFolder $OutputFolder